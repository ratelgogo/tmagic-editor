...
export interface InstallOptions {
  parseDSL: <T = unknown>(dsl: string) => T;
  [key: string]: unknown;
}
...
export interface PropsState {
  propsConfigMap: Map<string, FormConfig>;
  propsValueMap: Map<string, Partial<MNode>>;
}
...
export interface MenuButton {
  ...
  handler?: (data: Services, event: MouseEvent) => Promise<unknown> | unknown;
  className?: string;
